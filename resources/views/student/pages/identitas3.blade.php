        ...
        <form action="{{ route('student.update3', $student->id) }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-sm-6">
                    ...
                    <input type="text" id="nisn" name="nisn" class="form-control max-10 angka" placeholder="Masukkan nisn"
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" id="asal_sekolah" name="asal_sekolah" class="form-control max-255" placeholder="Masukkan sekolah sebelumnya"
                ...
                <div class="col-12 d-flex justify-content-between pt-4">
                    <a href="{{ route('student.edit2', $student->nisn) }}" type="button" class="btn btn-label-secondary btn-prev">
