        ...
        <form action="{{ route('student.update2', $student->id) }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-sm-6">
                    ...
                    <input type="text" id="anak_keberapa" name="anak_keberapa" class="form-control max-3 angka" placeholder="Masukkan anak keberapa"
                ...
                <div class="col-sm-6">
                    ...
                    <div class="input-group">
                        <input type="text" id="jumlah_saudara" name="jumlah_saudara" class="form-control max-3 angka"
                            placeholder="Masukkan jumlah saudara" value="{{ old('jumlah_saudara', $student->jumlah_saudara ?? '') }}"
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" id="transportasi" name="transportasi" class="form-control max-50"
                        placeholder="Masukkan transportasi yang digunakan" value="{{ old('transportasi', $student->transportasi ?? '') }}"
                        @disabled($student->registration->is_locked) />
                    @error('transportasi')
                ...
                <div class="col-sm-6">
                    ...
                    <div class="input-group">
                        <input type="text" id="jarak_tempuh" name="jarak_tempuh" class="form-control max-6 desimal" placeholder="Masukkan jarak tempuh"
                ...
                <div class="col-sm-6">
                    ...
                    <div class="input-group">
                        <input type="text" id="waktu_tempuh" name="waktu_tempuh" class="form-control max-3 angka" placeholder="Masukkan waktu tempuh"
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" id="no_kk" name="no_kk" class="form-control max-16 angka" placeholder="Masukkan nomor kartu keluarga"
                        value="{{ old('no_kk', $student->no_kk ?? '') }}" @disabled($student->registration->is_locked) />
                    @error('no_kk')
                ...
                <div class="col-sm-6 mb-5">
                    ...
                    <input type="text" id="no_kip_pkh_kks_kps" name="no_kip_pkh_kks_kps" class="form-control max-30 angka"
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" id="nama_ayah" name="nama_ayah" class="form-control max-255" placeholder="Masukkan nama ayah"
                        value="{{ old('nama_ayah', $student->guardian->nama_ayah ?? '') }}" @disabled($student->registration->is_locked) />
                    @error('nama_ayah')
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" id="nik_ayah" name="nik_ayah" class="form-control max-16 angka"
                        placeholder="Masukkan nomor induk kependudukan" value="{{ old('nik_ayah', $student->guardian->nik_ayah ?? '') }}"
                        @disabled($student->registration->is_locked) />
                    @error('nik_ayah')
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" id="tempat_lahir_ayah" name="tempat_lahir_ayah" class="form-control max-255"
                        placeholder="Masukkan tempat lahir ayah" value="{{ old('tempat_lahir_ayah', $student->guardian->tempat_lahir_ayah ?? '') }}"
                        @disabled($student->registration->is_locked) />
                ...
                <div class="col-sm-6">
                    ...
                    <input type="date" id="tanggal_lahir_ayah" name="tanggal_lahir_ayah" class="form-control"
                        value="{{ old('tanggal_lahir_ayah', $student->guardian->tanggal_lahir_ayah ?? '') }}" @disabled($student->registration->is_locked) />
                ...
                <div class="col-sm-6">
                    ...
                    <select id="father_education_id" name="father_education_id" class="select2" @disabled($student->registration->is_locked)>
                        <option label="" selected disabled>Pilih salah satu</option>
                ...
                <div class="col-sm-6">
                    ...
                    <select id="father_occupation_id" name="father_occupation_id" class="select2" @disabled($student->registration->is_locked)>
                        <option label="" selected disabled>Pilih salah satu</option>
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" name="penghasilan_ayah" id="penghasilan_ayah" class="form-control max-20 penghasilan"
                        placeholder="Masukkan penghasilan perbulan" value="{{ old('penghasilan_ayah', $student->guardian->penghasilan_ayah ?? '') }}"
                        @disabled($student->registration->is_locked) />
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control phone" id="hp_ayah" name="hp_ayah" placeholder="Masukkan nomor hp/wa"
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" id="nama_ibu" name="nama_ibu" class="form-control max-255" placeholder="Masukkan nama ibu"
                        value="{{ old('nama_ibu', $student->guardian->nama_ibu ?? '') }}" @disabled($student->registration->is_locked) />
                    @error('nama_ibu')
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" id="nik_ibu" name="nik_ibu" class="form-control max-16 angka"
                        placeholder="Masukkan nomor induk kependudukan" value="{{ old('nik_ibu', $student->guardian->nik_ibu ?? '') }}"
                        @disabled($student->registration->is_locked) />
                    @error('nik_ibu')
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" id="tempat_lahir_ibu" name="tempat_lahir_ibu" class="form-control max-255"
                        placeholder="Masukkan tempat lahir ibu" value="{{ old('tempat_lahir_ibu', $student->guardian->tempat_lahir_ibu ?? '') }}"
                        @disabled($student->registration->is_locked) />
                ...
                <div class="col-sm-6">
                    ...
                    <input type="date" id="tanggal_lahir_ibu" name="tanggal_lahir_ibu" class="form-control"
                        value="{{ old('tanggal_lahir_ibu', $student->guardian->tanggal_lahir_ibu ?? '') }}" @disabled($student->registration->is_locked) />
                ...
                <div class="col-sm-6">
                    ...
                    <select id="mother_education_id" name="mother_education_id" class="select2" @disabled($student->registration->is_locked)>
                        <option label="" selected disabled>Pilih salah satu</option>
                        @foreach ($educations as $education)
                ...
                <div class="col-sm-6">
                    ...
                    <select id="mother_occupation_id" name="mother_occupation_id" class="select2" @disabled($student->registration->is_locked)>
                        <option label="" selected disabled>Pilih salah satu</option>
                        @foreach ($occupations as $occupation)
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" name="penghasilan_ibu" id="penghasilan_ibu" class="form-control max-20 penghasilan"
                        placeholder="Masukkan penghasilan perbulan" value="{{ old('penghasilan_ibu', $student->guardian->penghasilan_ibu ?? '') }}"
                        @disabled($student->registration->is_locked) />
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control phone" id="hp_ibu" name="hp_ibu" placeholder="Masukkan nomor hp/wa"
                        value="{{ old('hp_ibu', $student->guardian->hp_ibu ?? '') }}" @disabled($student->registration->is_locked) />
                    @error('hp_ibu')
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" id="nama_wali" name="nama_wali" class="form-control max-255" placeholder="Masukkan nama wali"
                        value="{{ old('nama_wali', $student->guardian->nama_wali ?? '') }}" @disabled($student->registration->is_locked) />
                    @error('nama_wali')
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" id="tempat_lahir_wali" name="tempat_lahir_wali" class="form-control max-255"
                        placeholder="Masukkan tempat lahir wali" value="{{ old('tempat_lahir_wali', $student->guardian->tempat_lahir_wali ?? '') }}"
                        @disabled($student->registration->is_locked) />
                ...
                <div class="col-sm-6">
                    ...
                    <input type="date" id="tanggal_lahir_wali" name="tanggal_lahir_wali" class="form-control"
                        value="{{ old('tanggal_lahir_wali', $student->guardian->tanggal_lahir_wali ?? '') }}" @disabled($student->registration->is_locked) />
                ...
                <div class="col-sm-6">
                    <label for="wali_education_id" class="form-label fw-bold">Pendidikan Wali <span
                            class="form-text text-primary fst-italic">*Opsional</span></label>
                    <select id="wali_education_id" name="wali_education_id" class="select2" @disabled($student->registration->is_locked)>
                        <option label="" selected disabled>Pilih salah satu</option>
                        @foreach ($educations as $education)
                ...
                <div class="col-sm-6">
                    <label for="wali_occupation_id" class="form-label fw-bold">Pekerjaan Wali <span
                            class="form-text text-primary fst-italic">*Opsional</span></label>
                    <select id="wali_occupation_id" name="wali_occupation_id" class="select2" @disabled($student->registration->is_locked)>
                        <option label="" selected disabled>Pilih salah satu</option>
                        @foreach ($occupations as $occupation)
                ...
                <div class="col-sm-6">
                    <label class="form-label fw-bold" for="penghasilan_wali">Penghasilan Wali <span
                            class="form-text text-primary fst-italic">*Opsional</span></label>
                    <input type="text" name="penghasilan_wali" id="penghasilan_wali" class="form-control max-20 penghasilan"
                        placeholder="Masukkan penghasilan perbulan" value="{{ old('penghasilan_wali', $student->guardian->penghasilan_wali ?? '') }}"
                        @disabled($student->registration->is_locked) />
                ...
                <div class="col-sm-6">
                    <label for="hp_wali" class="form-label fw-bold">HP/WA Wali <span
                            class="form-text text-primary fst-italic">*Opsional</span></label>
                    <input type="text" class="form-control phone" id="hp_wali" name="hp_wali" placeholder="Masukkan nomor hp/wa"
                ...
                <div class="col-12 d-flex justify-content-between">
                    <a href="{{ route('student.edit1', $student->nisn) }}" type="button" class="btn btn-label-secondary btn-prev">
                    ...
                    @else
                        <a href="{{ route('student.edit3', $student->nisn) }}" type="button" class="btn btn-primary btn-next">
