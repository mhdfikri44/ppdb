...
@section('content')
    <h4 class="fw-bold mb-4">
        <span class="text-muted fw-light">Admin / </span> Penjadwalan Tes Tertulis
    </h4>
        ...
        <div class="col">
            ...
            <div class="card">
                <div class="card-datatable table-responsive">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div class="flex-grow-1 me-2">
                            <form id="formImport" action="{{ route('admin.test.import.jadwal') }}" method="post"
                                ...
                                <input type="hidden" name="type" value="tertulis">
                            </form>
                            @error('jadwal_tes')
                    ...
                    <table class="test-written-datatable table table-bordered table-hover table-striped table-sm">
                        <thead>
                            <tr>
                                <th>No</th>
...
@section('datatable-script')
    <script>
        let table = $(".test-written-datatable").DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.test.tertulis.data') }}",
            lengthMenu: [
                [10, 25, 50],
                [10, 25, 50]
            ],
        ...
        $('#clearJadwal').on('click', function() {
            Swal.fire({
                titleText: "Yakin ingin mengosongkan jadwal tes tertulis?",
